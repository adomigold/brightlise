        ...
        <section id="1" className="container mb-3 my-md-0 py-5 py-md-6">
            <div className="row align-items-center">
                <div className="col-lg-4 col-md-5 order-md-1 order-2 text-md-start text-center">
                    <h1 className="display-4 mb-lg-4 mb-3">Welcome to LISE Schools.</h1>
                    <p className="mb-lg-5 mb-4 text-muted" style={{ textAlign: 'justify' }}>
                        ...
                        It can be difficult to decide what is best for your child but at LISE Schools, we truly believe
