    ...
    return (
        <>
            ...
            <a className="navbar-brand flex-shrink-0 order-lg-1 mx-auto ms-lg-0 pe-lg-2" href="index.html">
                <img style={{"marginTop":"-20px"}} className="d-none d-lg-block" src="img/logo/logo.png" alt="Around" width="150" />
                <img className="d-lg-none" src="img/logo/logo.png" alt="Around" width="150" />
            </a>
        </>
    )
}